        ...
        <div>
            ...
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <select defaultValue="Pick a Job type" className="select select-ghost w-full input-bordered">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 items-end'>
                    ...
                    <div className="form-control">
                        <select defaultValue="Currency" name="currency" className="select select-ghost w-full input-bordered ">
